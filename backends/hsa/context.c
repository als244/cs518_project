...
// HIP CONTEXT ARE DEPRECATED
// THUS USING SET DEVICE AND STREAM TO MIMIC CONTEXT
// ZERO ALSO DOESN'T HAVE "CONTEXTS" SO IN REAL VERSION
// WILL CHOOSE BETTER ABSTRACTION ("CONTROLLER"?)
...
Hip_Context * hsa_init_context(int device_id){
	...
	Hip_Context * hip_context = (Hip_Context *) malloc(sizeof(Hip_Context));
	...
	hip_context -> device_id = device_id;
